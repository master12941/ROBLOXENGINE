...
Exploits2:NewToggle("Unlock Algorithm", "Unlocks Algorithms (Regardless of level)", function(state)
    ...
    if state then
        ...
        game:GetService("Players").LocalPlayer.PlayerGui.Phone.Frame.Apps.MiningAlgorithms.Locked.Visible = false
        game:GetService("Players").LocalPlayer.PlayerGui.Phone.Frame.Apps.MiningAlgorithms.Controller.Disabled = false
    else
        print("Algorithm Locked")
        game:GetService("Players").LocalPlayer.PlayerGui.Phone.Frame.Apps.MiningAlgorithms.Locked.Visible = true
        game:GetService("Players").LocalPlayer.PlayerGui.Phone.Frame.Apps.MiningAlgorithms.Controller.Disabled = true
    end
end)
...
-- Teleportation
local Teleport = Window:NewTab("Teleportation")
local Teleport1 = Teleport:NewSection("Locations")
...
local Misc2 = Misc:NewSection("Extra")

Misc2:NewToggle("Anti AFK", "Prevents you from being kicked", function(state)
...
Misc2:NewKeybind("Toggle UI", "Shows/Hides UI", Enum.KeyCode.F, function()
	Library:ToggleUI()
end)
